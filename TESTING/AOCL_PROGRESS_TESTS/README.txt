...
1) The scalapack build system generates aocl-progress related test binaries along with test suite application as part of the build process.
...
3) The aocl-progress related tests can be run with the below command:
   Ex: mpirun -np 4 ./xap_pdgetrf  32  8 2 2
