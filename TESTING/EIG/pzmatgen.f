...
*
      ...
      JSEED(2) = 0
*
*     Extreme-value parameter calculations
...
*                    Replace with NANs/INFs for extreme values
     ...
     $                     TOT_CNT .GE. REGION) THEN
                        IF ( CNT .LT. CNT1) THEN
                           A(IK, JK) = DCMPLX(ZERO1/ZERO1,ZERO1/ZERO1)
                        ELSE IF ( CNT .LT. (CNT1 + CNT2)) THEN
                           A(IK, JK) = DCMPLX(ONE1/ZERO1, ONE1/ZERO1)
                        END IF
                        CNT = CNT + 1
                        TOT_CNT = TOT_CNT + 1
                     ELSE
...
*
     ...
     $                    .AND. TOT_CNT .GT. (N/2) ) THEN
                         IF ( CNT .LT. CNT1) THEN
                           A(IK, JK+J) = DCMPLX(ZERO1/ZERO1,ZERO1/ZERO1)
                         ELSE IF ( CNT .LT. (CNT1 + CNT2)) THEN
                           A(IK, JK+J) = DCMPLX(ONE1/ZERO1, ONE1/ZERO1)
                         END IF
                         CNT = CNT + 1
                         TOT_CNT = TOT_CNT + 1
                     ELSE IF( HERM ) THEN
