...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  EQUED, IA, JA, M, N, AMAX,
     $            COLCND, ROWCND, eos_str
 102     FORMAT('PZLAQGE inputs: ,EQUED:',A5,', IA:',I9,
     $           ', JA:',I9,', M:',I9,', N:',I9,', AMAX:',F9.4,
     $           ', COLCND:',F9.4,', ROWCND:',F9.4, A1 )
