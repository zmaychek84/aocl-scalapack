...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  N, IX, JX, INCX, IY, JY, INCY,
     $            LWORK, INFO, CS, SN, NPROW, NPCOL,
     $            MYROW, MYCOL, eos_str
 102     FORMAT('PDROT inputs:,N:',I5,',IX:',I5,',JX:',I5,
     $           ',INCX:',I5,',IY:',I5,',JY:',I5,',INCY:',I5,
     $           ',LWORK:',I5,',INFO:',I5,
     $           ',CS:',F9.4,',SN:',F9.4,',NPROW:',I5,
