...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  SIDE, TRANS, UPLO, IA, IC, INFO,
     $            JA, JC, LWORK, M, N, NPROW, NPCOL,
     $            MYROW, MYCOL, eos_str
 102     FORMAT('PDORMTR inputs:,SIDE:',A5,',TRANS:',A5,
     $           ',UPLO:',A5,',IA:',I5,',IC:',I5,',INFO:',I5,
     $           ',JA:',I5,',JC:',I5,',LWORK:',I5,
     $           ',M:',I5,',N:',I5,',NPROW:',I5,
