...
*
      IF( SCALAPACK_CONTEXT%IS_LOG_ENABLED.EQ.1 ) THEN
         WRITE(LOG_BUF,102)  UPLO, IA, JA, M, N, real(ALPHA),
     $           ' + i ',aimag(ALPHA),real(BETA),
     $           ' + i ',aimag(BETA), eos_str
 102     FORMAT('PCLASE2 inputs: ,UPLO:',A5,', IA:',I5,
     $           ', JA:',I5,', M:',I5,', N:',I5,', ALPHA:',F9.4, A, F9.4,
     $           ', BETA:',F9.4, A, F9.4, A1 )
